...
import com.uma.foodborne.adapters.RecipesAdapter;
...
public class MainActivity extends Activity {
    ...
    private void actualizarRecycler(int mode, String information, int offset){
        ...
        ArrayList<Receta> recipes = null;
        try {
            recipes = Receta.createRecipesList(NUM_RECETAS, mode, offset, information, this);
        } catch (Exception  e) {
