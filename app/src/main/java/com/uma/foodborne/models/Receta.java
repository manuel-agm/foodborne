package com.uma.foodborne.models;
...
import com.uma.foodborne.MainActivity;
...
public class Receta {
    ...
    public Receta(int id, String title, String image){
        this.id = id;
        this.title = title;
        this.image = image;
    }
    ...
    public static ArrayList<Receta> createRecipesList(int numRecipes, int mode, int offset, String information, MainActivity mainActivity) throws JSONException, InterruptedException {
        ArrayList<Receta> recipes = new ArrayList<Receta>();
        ...
        for(int i = 0; i <numRecipes;i++) {
            ...
            recipes.add(new Receta(object.getInt("id"), object.getString("title"), object.getString("image").split("/")[object.getString("image").split("/").length-1]));
        }
